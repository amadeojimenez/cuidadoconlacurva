const drawPowerupIcons = (icon) => {
  let pathClear = new Path2D(
    "M843.7,843.7H236.4V236.3c147.4,0,372.9,0,607.3,0V843.7z M269.6,810.4h540.8V269.6H269.6L269.6,810.4 L269.6,810.4z"
  );
  // let pathFast = new Path2D("M512,0C229.2,0,0,229.2,0,512s229.2,512,512,512s512-229.2,512-512S794.8,0,512,0z M512,945.1 c-229.2,0-414.1-184.9-414.1-414.1S282.8,116.9,512,116.9S926.1,301.8,926.1,531S741.2,945.1,512,945.1z")
  ...
  let pathFast = new Path2D(
    "M512,0C229.2,0,0,229.2,0,512s229.2,512,512,512s512-229.2,512-512S794.8,0,512,0z M512,945.1 c-229.2,0-414.1-184.9-414.1-414.1S282.8,116.9,512,116.9S926.1,301.8,926.1,531S741.2,945.1,512,945.1z"
  );
  ...
  let pathSides1 = new Path2D(
    "M810.4,810.4h-33.2v33.2h66.5c0-26.1,0-51.1,0-66.5h-33.2V810.4z"
  );
  let pathSides2 = new Path2D(
    "M397.7,810.4h94.9v33.2c-30.7,0-62.7,0-94.9,0V810.4z"
  );
  let pathSides3 = new Path2D(
    "M587.4,810.4h94.9v33.2c-26.5,0-60.4,0-94.9,0V810.4z"
  );
  let pathSides4 = new Path2D(
    "M269.6,777.2h-33.2v66.5c16.9,0,39,0,66.5,0v-33.2h-33.2V777.2z"
  );
  let pathSides5 = new Path2D(
    "M236.4,587.4h33.2v94.9c-11.1,0-22.2,0-33.2,0V587.4z"
  );
  let pathSides6 = new Path2D(
    "M236.4,397.7h33.2v94.9c-11.1,0-22.2,0-33.2,0V397.7z"
  );
  let pathSides7 = new Path2D(
    "M236.4,302.8c11.1,0,22.2,0,33.2,0v-33.2h33.2v-33.2h-66.5V302.8z"
  );
  let pathSides8 = new Path2D(
    "M397.7,236.3h94.9v33.2c-33.8,0-69.1,0-94.9,0V236.3z"
  );
  let pathSides9 = new Path2D(
    "M587.4,236.3c41.4,0,70.7,0,94.9,0v33.2h-94.9V236.3z"
  );
  let pathSides10 = new Path2D(
    "M777.2,236.3v33.2h33.2v33.2h33.2v-66.5C821.5,235.9,799.3,235.9,777.2,236.3z"
  );
  let pathSides11 = new Path2D(
    "M810.4,397.7h33.2c0,52,0,75.3,0,94.9h-33.2V397.7z"
  );
  let pathSides12 = new Path2D(
    "M810.4,587.4h33.2c-0.1,36.2-0.1,67.8,0,94.9h-33.2V587.4z"
  );
  ...
  let pathSlow2 = new Path2D(
    "M625.4,366.1v31.1c-35.4,0.1-77.4,0-123.6,0v-26.5l77-101.3h-77v-31.1h121.5v26.5l-76.2,101.3H625.4z"
  );
  ...
  let pathThick = new Path2D(
    "M806.8,190l-104.6-55.2C476.2,318,325.5,565.2,273.1,890l104.6,55.2C606.2,765,750.2,514.1,806.8,190 L806.8,190z"
  );
  let pathThin = new Path2D(
    "M377.8,945.1C475.6,686.6,615.1,433.9,806.8,190l-104.6-55.1C602,392.1,462,644,273.1,890L377.8,945.1z"
  );
