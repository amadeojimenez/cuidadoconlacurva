...
function init() {
    ...
    ctxDO.strokeRect(borderWidth / 2, 10* borderWidth / 2, h - borderWidth, h - borderWidth)
    // ctxDO2.lineWidth = borderWidth
    // ctxDO2.strokeStyle = yellow
    ctxDO.strokeRect(h/2 + borderWidth / 2, h/2 +  borderWidth / 2, h/4 - borderWidth, h/4 - borderWidth)
...
function draw() {
    ...
    if (achtung.sides != 0) { ctxDO.strokeStyle = `rgba(255, 55, 0, ${Math.abs(tFrame % 40 - 20) / 20})` } else ctxDO.strokeStyle = yellow //if sides, border flickers
    ctxDO.strokeRect(borderWidth / 2, borderWidth / 2, h - borderWidth, h - borderWidth)
